...
qemu -no-kvm -vnc :0 -k en-us -cdrom snowflake.iso -hda archive.tar -m 512 -vga vmware -serial stdio -net user,vlan=5 -net dump,vlan=5,file=network.cap -net nic,vlan=5,model=rtl8139 -soundhw ac97
